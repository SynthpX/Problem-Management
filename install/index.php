...
<html>
	<head>
		...
		<title>Install Aplikasi Problem Management</title>
		<link href="https://maxcdn.bootstrapcdn.com/bootswatch/3.3.7/cosmo/bootstrap.min.css" rel="stylesheet">
	</head>
	<body>
    <div class="container">
        <div class="col-md-4 col-md-offset-4">
            <h1>Installer Aplikasi Problem Management</h1>
            <hr>
            <?php 
            ...
            ?>
                ...
                <div class="form-group">
                    ...
                    <p class="help-block">Username Database.</p>
                </div>
                
                <div class="form-group">
                    <label for="password">Password</label>
                    <input type="password" id="password" class="form-control" name="password"/>
                    <p class="help-block">Password Database.</p>
                </div>
                
                <div class="form-group">
                    <label for="database">Database Name</label>
                    <input type="text" id="database" class="form-control" name="database"/>
                    <p class="help-block">Nama Database.</p>
                </div>
                <?php
                 $url =  "http://{$_SERVER['HTTP_HOST']}{$_SERVER['REQUEST_URI']}";

                $escaped_url = htmlspecialchars( $url, ENT_QUOTES, 'UTF-8' );
                $urlparse = parse_url($escaped_url);
                $path = $urlparse[path];
                $hasilp = substr($path, 0,-9);
                $realurl = $urlparse[host];
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="url" class="form-control" name="url" value="<?= 'http://'.$realurl.$hasilp ?>"/>
                    <p class="help-block">Your URL Website.</p>
                </div>
                
                <div class="form-group">
                    <label for="database">Versi Code Igniter(Default : 3)</label>
            ...
            <footer>
                <div class="col-md-12" style="text-align:center;margin-bottom:20px">
                    <hr>
                    Copyright - 2019 | <a href="https://ArtOfDev.asia">ArtOfDev</a>
                </div>
            </footer>
      </div>
